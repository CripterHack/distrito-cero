...
R=Path(__file__).resolve().parents[1];O=R/'qa/v014';O.mkdir(parents=True,exist_ok=True);name=sys.argv[1] if len(sys.argv)>1 else 'full';os.environ.setdefault('DISPLAY',':99')
