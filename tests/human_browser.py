"""v0.9 DOM/paired-animation/streaming regression. Actual WebGL keyframes.
...
R=Path(__file__).resolve().parents[1];O=R/'qa/v09';O.mkdir(exist_ok=True);os.environ.setdefault('DISPLAY',':99')
