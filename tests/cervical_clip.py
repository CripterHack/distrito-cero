...
R=Path(__file__).resolve().parents[1];O=R/'qa/v014';F=O/'clip-frames';F.mkdir(exist_ok=True)
...
with sync_playwright() as pw:
 ...
 for phase in range(2):
  for i in range(per):
   ...
   d=ImageDraw.Draw(frame);d.rectangle((0,0,frame.width,66),fill=(12,19,24));d.text((20,12),'DISTRITO CERO  v0.14',fill=(220,233,220),font=font);d.text((20,39),labels[phase],fill=(228,233,237),font=small)
