...
R=Path(__file__).resolve().parents[1];O=R/'qa/v09';name=sys.argv[1] if len(sys.argv)>1 else 'driver';tag=os.environ.get('DC_REVIEW_TAG','');os.environ.setdefault('DISPLAY',':99')
