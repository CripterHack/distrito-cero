...
with sync_playwright() as pw:
 ...
 p.evaluate("const a=DC_APP,s=a.sim;s.free=true;Object.assign(s.player,{x:4,z:40,y:0,yaw:0});document.getElementById('chapter').style.display='none';document.getElementById('toast').style.display='none';a.setMode('photo');a.renderer.camera.eye=[4.60,1.60,41.45];a.renderer.camera.target=[4,1.37,40];a.renderer.daylight=.60;a.renderer.rain=0;drawActual(s)")
 ...
 p.screenshot(path=str(ROOT/'qa/v08/01-rostro.png'),timeout=60000)
 b.close()
