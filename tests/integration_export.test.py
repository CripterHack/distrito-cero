"""Structural checks on the actual v0.15 textured authoring export, not historical GLBs."""
...
class HumanExport(unittest.TestCase):
 def test_textured_rigged_export(self):
  f=R/'assets/dc015-human-integrated.glb'
  self.assertTrue(f.is_file(),'v0.15 textured export is missing')
