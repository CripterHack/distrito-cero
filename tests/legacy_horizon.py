...
OUT=ROOT/'qa/v07/legacy';OUT.mkdir(parents=True,exist_ok=True)
...
with sync_playwright() as p:
    ...
    page.keyboard.down('Space');page.wait_for_function('Math.abs(DC_APP.sim.actor().speed)<3.5',timeout=15000);page.keyboard.up('Space');page.keyboard.press('f')
