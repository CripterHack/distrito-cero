...
Este directorio conserva insumos de autoría, bases geométricas, exportaciones GLB y referencias de QA de varias versiones. **El juego vigente es v0.20.11**, no la versión indicada en el nombre de cada recurso.
