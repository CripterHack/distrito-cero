...
def hero():
 g=GLB('DC015 integrated cervical constitution');bones=D['bones'];ids={b[0]:i+1 for i,b in enumerate(bones)}
 ...
 return g.write(ROOT/'assets/dc015-human-integrated.glb')

if __name__=='__main__':
 report=hero();(ROOT/'assets/integration-export.json').write_text(json.dumps(report,indent=2));print(json.dumps(report,indent=2))
