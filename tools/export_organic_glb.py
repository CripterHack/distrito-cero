...
def hero():
 ...
 return g.write(ROOT/'assets/dc013-human-motion.glb')

if __name__=='__main__':
 report=hero();(ROOT/'assets/organic-export.json').write_text(json.dumps(report,indent=2));print(json.dumps(report,indent=2))
