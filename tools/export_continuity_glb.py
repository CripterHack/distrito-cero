...
def hero():
 g=GLB('DC012 anatomical continuity');bones=D['bones'];ids={b[0]:i+1 for i,b in enumerate(bones)}
 ...
 return g.write(ROOT/'assets/dc012-human-continuity.glb')

if __name__=='__main__':
 report=hero();(ROOT/'assets/continuity-export.json').write_text(json.dumps(report,indent=2));print(json.dumps(report,indent=2))
