...
def hero():
 g=GLB('DC09 textured protagonist');bones=D['bones'];ids={b[0]:i+1 for i,b in enumerate(bones)}
 ...
 for part in D['hero']['parts']:
  ...
  rough={30:.55,31:.86,32:.91,33:.67,34:.16,40:1,41:.19,42:.72,3:.32,4:.82}.get(part['material'],.75)
 ...
 return g.write(ROOT/'assets/dc09-human-textured.glb')

if __name__=='__main__':
 report=hero();(ROOT/'assets/human-export.json').write_text(json.dumps(report,indent=2));print(json.dumps(report,indent=2))
