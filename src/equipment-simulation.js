...
(function(D){
 ...
 class EquipmentSimulation extends Base{
  ...
  equipWeapon(id,actorOverride=null){if(!E.get(id))return false;const e=this.equipment;if(e.selected===id)return true;const handoff=D.WeaponHandling.captureSwitch(this,id,actorOverride);this.cancelEquipment();Object.assign(e,{selected:id,reloading:0,reloadId:null,recoil:0,cooldown:e.cooldown});D.WeaponHandling.beginEquip(this,handoff);this.emit('sound','equip');return true;}
