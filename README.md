...
Aventura criminal original de navegador con exploración, conducción y una ciudad procedural. **Versión jugable: v0.20.8 · Coherencia (`0.20.8`, prototipo).** JavaScript, WebGL2, Canvas 2D y Web Audio nativos. Un HTML autónomo, sin librerías externas, CDN, telemetría remota ni conexión obligatoria durante la partida.
